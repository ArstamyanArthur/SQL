...
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'EDP')
DROP DATABASE [EDP]
GO
...
( NAME = N'Emp_Dept_Pro', FILENAME = N'D:\DBMS_Bacalavr\SQLDATA\Emp_Dept_Pro.mdf' , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Emp_Dept_Pro_log', FILENAME = N'D:\DBMS_Bacalavr\SQLDATA\Emp_Dept_Pro_log.LDF', MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
insert into [Workers] values(27,'Harutyunjan Gayane','04/01/1970',60000,4,7)
